                          ...
                          <li>
                            ...
                            <div className={`${styles["radio-default"]}`} style={{ marginLeft: "-20px" }}>
                              <ul>
                                <li>
                                  <div className={`${styles["form-check"]} form-check`}>
                                    <input className={`${styles["check-radio"]}`} type="radio" name="default" id="yes" />
                                    <label className={`${styles["form-label"]} form-check-label ms-2`} for="yes">
                                      Yes
                                    </label>
                                  </div>
                                </li>
                                <li className="ms-5">
                                  <ul>
                                    <li>
                                      <div className={`${styles["form-check"]} form-check`}>
                                        <input className={`${styles["check-radio"]}`} type="radio" name="default" id="filter" />
                                        <label className={`${styles["form-label"]} form-check-label ms-2`} for="filter">
                                          Select Filter
                                        </label>
                                      </div>
                                    </li>
                          ...
                          <li>
                            ...
                            <div className="my-3">
                              ...
                              <ul style={{ marginLeft: "-20px" }}>
                                <li>
                                  <div className={`${styles["form-check"]} form-check`}>
                                    <input className={`${styles["check-radio"]}`} type="radio" name="taxGroup" id="irregular" />
                                    <label className={`${styles["form-label"]} form-check-label ms-2`} for="irregular">
                                      Irregular
                                    </label>
                                  </div>
                                </li>
                                <li>
                                  <div className={`${styles["form-check"]} form-check`}>
                                    <input className={`${styles["check-radio"]}`} type="radio" name="taxGroup" id="regular" />
                                    <label className={`${styles["form-label"]} form-check-label ms-2`} for="regular">
                                      Regular
                                    </label>
                                  </div>
                                </li>
                        ...
                        <ul>
                          <li className={`d-flex justify-content-start`}>
                            ...
                            <div class="ms-3">
                              ...
                              <div className={`${styles["form-check"]} form-check`}>
                                <input className={`${styles["check-radio"]}`} type="radio" name="rLimit" id="month" />
                                <label className={`${styles["form-label"]} form-check-label col-5 ms-2`} for="month">
                                  Amount
                                </label>
                              </div>
                              <div className="d-flex justify-content-start">
                                ...
                                <button type="button" className={`${styles["btn-box"]} btn btn-outline-secondary btn-sm ms-3`} data-bs-toggle="modal" data-bs-target="#formula">
                                  FORMULA
                                </button>
                              </div>
                            </div>
