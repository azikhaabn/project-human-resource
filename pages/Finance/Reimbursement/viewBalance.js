...
import { ColumnsViewBalance } from "./ColumnsViewBalance";
import View_Balance from "./View_Balance.json";
import { useSortBy, useTable } from "react-table";
import ShowingSearch from "../../Component/showingSearch";

const ViewBalance = () => {
  const columns = useMemo(() => ColumnsViewBalance, []);
  const data = useMemo(() => View_Balance, []);
    ...
    <div className={styles.container}>
      <div className={`${styles.modal} modal-content rounded-0`}>
        <div className={`${styles["modal-body"]} modal-body mx-3`}>
          <h2>Reimbursement Report Medical Claim</h2>
